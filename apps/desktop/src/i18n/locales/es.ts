export default {
  ...
  auth: {
    ...
    oidcLoginDescription: "Inicia sesión en DBX Enterprise con tu proveedor de identidad",
    oidcLoginHint: "Se te redirigirá al SSO corporativo y volverás aquí después de autenticarte.",
    loginWithProvider: "Continuar con {provider}",
    defaultProviderName: "SSO empresarial",
    mockModeHint: "El modo mock de OIDC está habilitado solo para desarrollo local.",
  ...
  audit: {
    ...
    description: "Consulta trazas estructuradas de autenticación, permisos, aprobaciones, ejecuciones y consultas.",
    eventsTab: "Eventos",
    queriesTab: "Consultas",
    refresh: "Actualizar",
    keyword: "Palabra clave",
    keywordPlaceholder: "Buscar por tipo de evento, recurso o payload",
    queryKeywordPlaceholder: "Buscar por resumen SQL, SQL o metadatos",
    category: "Categoría",
    ...
    emptyEvents: "No se encontraron eventos de auditoría",
    actor: "Actor",
    sourceIp: "IP de origen",
    resource: "Recurso",
    request: "Solicitud",
    payload: "Payload",
    emptySelection: "Selecciona un registro a la izquierda para ver el detalle.",
    datasource: "Origen de datos",
    datasourcePlaceholder: "Filtrar por id de datasource",
    databasePlaceholder: "Filtrar por base de datos",
    status: "Estado",
    allStatuses: "Todos los estados",
    operationType: "Tipo de operación",
    allOperationTypes: "Todos los tipos de operación",
    queriesCount: "{count} consultas",
    emptyQueries: "No se encontraron auditorías de consultas",
    ...
    errorCode: "Tipo de error",
    action: "Acción",
    resourceType: "Tipo de recurso",
    requestId: "Request ID",
    traceId: "Trace ID",
    actorPlaceholder: "Filtrar por email, nombre o ID de usuario",
    requestIdPlaceholder: "request_id exacto",
    traceIdPlaceholder: "trace_id exacto",
    notAvailable: "N/D",
    systemActor: "Sistema",
  ...
  grid: {
    ...
    policyRowFilterApplied: "filtro de filas aplicado",
    policyHiddenColumns: "{count} columna(s) ocultas",
    policyMaskedColumns: "{count} columna(s) enmascaradas",
    policyHiddenColumnList: "Ocultas: {columns}",
    policyMaskedColumnList: "Enmascaradas: {columns}",
  ...
  approval: {
    ...
    description: "Envía tickets DDL/DML, sigue el flujo de aprobación y revisa los resultados de ejecución.",
    createTab: "Nuevo ticket",
    myTicketsTab: "Mis tickets",
    pendingTab: "Pendientes",
    allTab: "Todos",
    defaultTitle: "Solicitud de cambio SQL",
    newTicketTitle: "Crear ticket de cambio SQL",
    newTicketDescription: "Envía una orden DDL o DML y enrútala mediante el flujo de aprobación configurado.",
    ticketTitle: "Título del ticket",
    datasource: "Origen de datos",
    datasourcePlaceholder: "Selecciona un origen",
    database: "Base de datos",
    schema: "Esquema",
    table: "Tabla",
    ...
    schedulePlaceholder: "Ejecutar justo después de aprobar",
    scheduleHint: "Déjalo vacío para ejecutar inmediatamente después de la aprobación final.",
    clearSchedule: "Limpiar",
    createDraft: "Crear borrador",
    createAndSubmit: "Crear y enviar",
    flowTemplate: "Vista previa del flujo",
    flowTemplateHint: "El backend elige un flujo incorporado según el tipo de ticket y el alcance.",
    flowsTab: "Plantillas",
    flowManagementTitle: "Gestión de plantillas de aprobación",
    flowManagementDescription: "Mantén plantillas multi-paso, reglas de coincidencia y asignaciones de aprobadores.",
    flowManagementHint:
      "La fase 1 admite coincidencia estática por tipo de ticket, origen, base de datos, esquema, tabla y nivel de riesgo.",
    createFlow: "Nueva plantilla",
    editFlow: "Editar plantilla",
    deleteFlow: "Eliminar plantilla",
    createFlowTitle: "Crear plantilla de aprobación",
    editFlowTitle: "Editar plantilla de aprobación",
    flowCode: "Código de plantilla",
    flowName: "Nombre de plantilla",
    flowDescription: "Descripción",
    ticketType: "Tipo de ticket",
    flowEnabled: "Estado de plantilla",
    flowSteps: "Pasos de aprobación",
    addFlowStep: "Agregar paso",
    removeFlowStep: "Quitar paso",
    flowStepNumber: "Paso {number}",
    flowStepName: "Nombre del paso",
    flowApproverType: "Tipo de aprobador",
    flowApproverRef: "Identificador del aprobador",
    flowApproverRefPlaceholder: "Por ejemplo: admin o user-123",
    flowApprovalMode: "Modo de aprobación",
    approverTypeRole: "Rol",
    approverTypeUser: "Usuario",
    approvalModeAnyOne: "Aprueba cualquiera",
    approvalModeAll: "Aprueban todos",
    matchTicketTypes: "Tipos de ticket",
    matchDatasourceIds: "Orígenes de datos",
    matchDatabases: "Bases de datos",
    matchSchemas: "Esquemas",
    matchTables: "Tablas",
    matchRiskLevels: "Niveles de riesgo",
    matchCommaPlaceholder: "Separa varios valores con comas",
    matchAny: "Cualquiera",
    flowMatchRuleSummary: "Tipos: {ticketTypes} / Orígenes: {datasources} / Bases: {databases} / Riesgo: {riskLevels}",
    noEditableFlows: "Todavía no hay plantillas personalizadas.",
    flowCreated: "Plantilla de aprobación creada",
    flowUpdated: "Plantilla de aprobación actualizada",
    flowDeleted: "Plantilla de aprobación eliminada",
    saveFlow: "Guardar plantilla",
    noTemplates: "Todavía no hay plantillas de aprobación disponibles.",
    loading: "Cargando datos de aprobación...",
    enabled: "Activo",
    disabled: "Inactivo",
    stepRule: "{approver} · {mode}",
    scopeMyDescription: "Borradores, tickets enviados y resultados que te pertenecen.",
    scopePendingDescription: "Tickets que esperan la aprobación o el rechazo de la cuenta actual.",
    scopeAllDescription: "Todos los tickets visibles para administradores empresariales.",
    emptyScope: "Todavía no hay tickets en este alcance.",
    ...
    approved: "Paso de aprobación aceptado",
    rejected: "Paso de aprobación rechazado",
    retried: "Reintento de ejecución en cola",
    createdAt: "Creado",
    submittedAt: "Enviado",
    approvedAt: "Aprobado",
    ...
    finishedAt: "Fin",
    executor: "Ejecutor",
    scheduleValue: "Programación: {value}",
    notScheduled: "Sin programar",
    statements: "Sentencias",
    approvalFlow: "Flujo de aprobación",
    noApprovalFlow: "Este ticket todavía no ha entrado en un flujo de aprobación.",
    executionJobs: "Trabajos de ejecución",
    noExecutionJobs: "Todavía no se han creado trabajos de ejecución.",
    statementSuccess: "Correcto",
    statementFailed: "Falló",
    affectedRows: "{rows} filas",
    decisionTitleApprove: "Aprobar paso actual",
    decisionTitleReject: "Rechazar paso actual",
    decisionComment: "Comentario",
    decisionCommentPlaceholder: "Nota opcional de aprobación",
