export default {
  ...
  auth: {
    ...
    oidcLoginDescription: "Sign in to DBX Enterprise with your identity provider",
    oidcLoginHint: "You will be redirected to your enterprise SSO and returned here after authentication.",
    loginWithProvider: "Continue with {provider}",
    defaultProviderName: "Enterprise SSO",
    mockModeHint: "OIDC mock mode is enabled for local development only.",
  ...
  audit: {
    title: "Audit Center",
    description: "Inspect authentication, permission, approval, execution, and query audit trails.",
    eventsTab: "Events",
    queriesTab: "Queries",
    refresh: "Refresh",
    keyword: "Keyword",
    keywordPlaceholder: "Search event type, resource, or payload",
    queryKeywordPlaceholder: "Search SQL summary, SQL text, or metadata",
    category: "Category",
    ...
    emptyEvents: "No audit events found",
    actor: "Actor",
    sourceIp: "Source IP",
    resource: "Resource",
    request: "Request",
    payload: "Payload",
    emptySelection: "Select a record on the left to inspect details.",
    datasource: "Datasource",
    datasourcePlaceholder: "Filter by datasource id",
    databasePlaceholder: "Filter by database name",
    status: "Status",
    allStatuses: "All statuses",
    operationType: "Operation Type",
    allOperationTypes: "All operation types",
    queriesCount: "{count} queries",
    emptyQueries: "No query audits found",
    database: "Database",
    ...
    traceId: "Trace ID",
    actorPlaceholder: "Filter by email, name, or user ID",
    requestIdPlaceholder: "Exact request_id",
    traceIdPlaceholder: "Exact trace_id",
    notAvailable: "N/A",
    systemActor: "System",
  ...
  grid: {
    ...
    policyRowFilterApplied: "row filter applied",
    policyHiddenColumns: "{count} column(s) hidden",
    policyMaskedColumns: "{count} column(s) masked",
    policyHiddenColumnList: "Hidden: {columns}",
    policyMaskedColumnList: "Masked: {columns}",
  ...
  approval: {
    ...
    description: "Submit DDL/DML change tickets, follow approval progress, and inspect execution results.",
    createTab: "New ticket",
    myTicketsTab: "My tickets",
    pendingTab: "Pending",
    allTab: "All tickets",
    defaultTitle: "SQL change request",
    newTicketTitle: "Create SQL change ticket",
    newTicketDescription: "Submit a DDL or DML work order and route it through the configured approval flow.",
    ...
    schedulePlaceholder: "Run immediately after approval",
    scheduleHint: "Leave empty to execute immediately after the final approval step.",
    clearSchedule: "Clear",
    createDraft: "Create draft",
    createAndSubmit: "Create and submit",
    flowTemplate: "Approval flow preview",
    flowTemplateHint: "The backend matches a built-in flow by ticket type and target scope.",
    flowsTab: "Flow templates",
    flowManagementTitle: "Approval template management",
    flowManagementDescription: "Maintain multi-step approval templates, matching rules, and approver assignments.",
    flowManagementHint:
      "Phase 1 supports static matching by ticket type, datasource, database, schema, table, and risk level.",
    createFlow: "New template",
    editFlow: "Edit template",
    deleteFlow: "Delete template",
    createFlowTitle: "Create approval template",
    editFlowTitle: "Edit approval template",
    flowCode: "Template code",
    flowName: "Template name",
    flowDescription: "Template description",
    ticketType: "Ticket type",
    flowEnabled: "Template status",
    flowSteps: "Approval steps",
    addFlowStep: "Add step",
    removeFlowStep: "Remove step",
    flowStepNumber: "Step {number}",
    flowStepName: "Step name",
    flowApproverType: "Approver type",
    flowApproverRef: "Approver reference",
    flowApproverRefPlaceholder: "For example: admin or user-123",
    flowApprovalMode: "Approval mode",
    approverTypeRole: "Role",
    approverTypeUser: "User",
    approvalModeAnyOne: "Any one approves",
    approvalModeAll: "All approve",
    matchTicketTypes: "Match ticket types",
    matchDatasourceIds: "Match datasources",
    matchDatabases: "Match databases",
    matchSchemas: "Match schemas",
    matchTables: "Match tables",
    matchRiskLevels: "Match risk levels",
    matchCommaPlaceholder: "Separate multiple values with commas",
    matchAny: "Any",
    flowMatchRuleSummary:
      "Types: {ticketTypes} / Datasources: {datasources} / Databases: {databases} / Risk: {riskLevels}",
    noEditableFlows: "No custom approval templates yet.",
    flowCreated: "Approval template created",
    flowUpdated: "Approval template updated",
    flowDeleted: "Approval template deleted",
    saveFlow: "Save template",
    noTemplates: "No approval templates are configured yet.",
    loading: "Loading approval data...",
    enabled: "Enabled",
    disabled: "Disabled",
    stepRule: "{approver} · {mode}",
    scopeMyDescription: "Drafts, submitted tickets, and execution results that belong to you.",
    scopePendingDescription: "Tickets waiting for the current account to approve or reject.",
    scopeAllDescription: "All tickets visible to enterprise administrators.",
    emptyScope: "No tickets in this scope yet.",
    ...
    retried: "Execution retry queued",
    createdAt: "Created",
    ...
    noApprovalFlow: "This ticket has not entered an approval flow yet.",
    executionJobs: "Execution jobs",
    noExecutionJobs: "No execution jobs have been created yet.",
    statementSuccess: "Success",
    statementFailed: "Failed",
    affectedRows: "{rows} rows",
    decisionTitleApprove: "Approve current step",
    decisionTitleReject: "Reject current step",
    decisionComment: "Comment",
    decisionCommentPlaceholder: "Optional approval note",
